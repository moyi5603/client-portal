...
const translations: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'account.status': '状态',
    'account.accessibleCustomers': '可访问Customer',
    'account.roles': '角色信息',
    'account.actions': '操作',
    'account.typeMain': '主账号',
    'account.typeCustomer': '客户子账号',
    'account.typePartner': 'Partner账号',
    'account.statusActive': '启用',
    'account.statusInactive': '禁用',
    'account.statusSuspended': '暂停',
    'account.allCustomers': '全部customer',
    'account.allPermissions': '全部权限',
    'account.noCustomers': '无',
    'account.noRoles': '无',
    'account.searchUsername': '用户名',
    'account.searchEmail': '邮箱',
    'account.searchPhone': '手机号',
    'account.selectAccountType': '账号类型',
    'account.selectCustomers': '可访问Customer',
    'account.selectStatus': '状态',
    'account.reset': '重置',
    'account.search': '搜索',
    'account.deleteConfirm': '确定要删除这个账号吗？',
    ...
    'account.phoneOptional': '选填',
    'account.selectCustomersPlaceholder': '请选择Customer',
    'account.selectRolesPlaceholder': '请选择角色',
    
    // 菜单管理
    'menu.title': '菜单管理',
    'menu.refresh': '刷新',
    'menu.selectAccount': '选择账号：',
    'menu.selectAccountPlaceholder': '请选择账号',
    'menu.accountVisibleMenus': '账号可见菜单（通过角色配置）',
    'menu.systemMenuList': '系统菜单列表',
    ...
    'menu.menuPermissionThroughRoles': '菜单权限通过角色进行管理，请到角色管理页面配置',
    'menu.menuPermissionTip': '提示：菜单权限通过角色进行管理。请到角色管理页面为角色分配菜单权限，然后为账号分配相应的角色。',
    'menu.systemMenuTip': '提示：菜单由系统预定义，不能创建或删除。请选择账号查看其可见菜单。',
    
    // 权限查看
    'permission.title': '权限查看',
    'permission.roleName': '角色名称',
    'permission.searchRoleName': '搜索角色名称...',
    'permission.permissionLegend': '权限图例',
    'permission.matrixView': '按所有角色',
    'permission.listView': '按所有页面',
    ...
    'login.tenantIdRequired': '请输入租户ID',
    'login.usernameRequired': '请输入用户名',
    'login.passwordRequired': '请输入密码',
    'login.testAccount': '测试账号：admin / admin / admin123',
  },
  'en-US': {
    // Common
    'common.save': 'Save',
    ...
    'account.accessibleCustomers': 'Accessible Customers',
    'account.roles': 'Roles',
    'account.actions': 'Actions',
    'account.typeMain': 'Main Account',
    'account.typeCustomer': 'Customer Sub-account',
    ...
    'account.searchUsername': 'Username',
    'account.searchEmail': 'Email',
    'account.searchPhone': 'Phone',
    'account.selectAccountType': 'Account Type',
    'account.selectCustomers': 'Accessible Customers',
    ...
    'account.selectCustomersPlaceholder': 'Please select customers',
    'account.selectRolesPlaceholder': 'Please select roles',
    
    // Menu Management
    'menu.title': 'Menu Management',
    'menu.refresh': 'Refresh',
    'menu.selectAccount': 'Select Account:',
    'menu.selectAccountPlaceholder': 'Please select account',
    'menu.accountVisibleMenus': 'Account Visible Menus (Configured via Roles)',
    'menu.systemMenuList': 'System Menu List',
    ...
    'menu.selectAccountFirst': 'Please select account first',
    'menu.updateMenuPermissionsFailed': 'Failed to update menu permissions',
    'menu.menuPermissionThroughRoles': 'Menu permissions are managed through roles, please configure in role management page',
    'menu.menuPermissionTip': 'Tip: Menu permissions are managed through roles. Please assign menu permissions to roles in the role management page, then assign corresponding roles to accounts.',
    'menu.systemMenuTip': 'Tip: Menus are predefined by the system and cannot be created or deleted. Please select an account to view its visible menus.',
    ...
    'permission.matrixView': 'All Roles',
    'permission.listView': 'All Pages',
    'permission.showingRoles': 'Showing {start} to {end} of {total} roles',
    'permission.showingPermissions': 'Showing {start} to {end} of {total} permission entries',
    ...
    'login.tenantIdRequired': 'Please enter tenant ID',
    'login.usernameRequired': 'Please enter username',
    'login.passwordRequired': 'Please enter password',
    'login.testAccount': 'Test Account: admin / admin / admin123',
  }
};
