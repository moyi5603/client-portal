...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn('dropdown-menu-sub-trigger', inset && 'dropdown-menu-item--inset', className)}
    {...props}
  >
    {children}
    <span className="dropdown-menu-sub-trigger-icon">›</span>
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, danger, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      danger && 'dropdown-menu-item--danger',
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('dropdown-menu-label', inset && 'dropdown-menu-item--inset', className)}
    {...props}
  />
));
